...
#sra_ini$n_breeding_pairs_raw_s[sra_dat$n_breeding_pairs_type == 0] <- (sra_dat$n_breeding_pairs_p1[sra_dat$n_breeding_pairs_type == 0] + sra_dat$n_breeding_pairs_p2[sra_dat$n_breeding_pairs_type == 0]) / 2;
```
