...
species_groups$species_group    <- species_groups$capture_type_group
species_groups$id_species_group <- species_groups$id_capture_type_group
```
...
sra_ini <- list(log_q_intercept = rep(-10, sra_dat$n_method),
                ...
                #n_breeding_pairs_raw_s = ifelse(N_BP$distribution == 'log-uniform', (N_BP$par1 + N_BP$par2) / 2, N_BP$par1),
                n_breeding_pairs_raw_0 = structure(with(subset(N_BP, distribution == 'log-uniform'), (par1 + par2) / 2), dim = sra_dat$n_breeding_pairs_type_0),
