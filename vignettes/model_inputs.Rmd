...
```{r, results = "asis", size = "scriptsize"}
tab_cap <- tab_nums(name = "tab:fishing_groups", caption = paste0("Fishing methods (", nrow(methods), ") and fishing groups (", nrow(fishing_groups), "). Observed and total effort, and percentage coverage, are reported using the number of fishing events. Fishing groups ", fishing_groups_remove$fishing_group_label, " were not present in the data or were removed."))
